...
import { Award, Users, Target, Sparkles, Briefcase, BookOpen } from 'lucide-react'
  ...
  return (
    <section id="academy" className="py-20 px-6 sm:px-8 lg:px-12 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Entri 1: Software Engineer Intern */}
        <motion.div
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900">
                    Software Engineer Intern, HR Systems
                  </h3>
              ...
              <div className="mb-6">
                <p className="text-gray-600 text-sm mb-2">
                  <span className="font-semibold">Aug 2026 – Sep 2026</span>
                </p>
              </div>

              <p className="text-gray-700 text-lg leading-relaxed">
                Implemented Frappe HR across two company environments (demo & real deployment for PTDI), building out a full HR module ecosystem — recruitment, attendance, leave, payroll, and a custom overtime management system. Configured CSV import workflows and Assignment Rules for real employee data spanning 258 departments and 3,000+ employees.
              </p>
            </div>
          </div>
        </motion.div>

        {/* Entri 2: AI Full-Stack Developer Track */}
        <motion.div
          initial={{ opacity: 0, scale: 0.95 }}
          whileInView={{ opacity: 1, scale: 1 }}
          viewport={{ once: true }}
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-pink-500 font-medium flex items-center gap-2 mt-1">
                    Studi Independen ASAH 2026 (Dicoding, didukung GoTo)
                  </p>
                </div>
              </div>
              ...
              <div className="mb-6">
                <p className="text-gray-600 text-sm mb-2">
                  <span className="font-semibold">Aug 2026 – Jan 2027</span>
                </p>
              </div>

              <p className="text-gray-700 text-lg leading-relaxed">
                Deepening full-stack and AI fundamentals — Front-End (React SPA), Back-End (JavaScript), and applied AI — through a ~250-hour capstone project solving a real-world problem, alongside Instructor-Led Soft Skills training.
              </p>
            </div>
          </div>
        </motion.div>
